...
{
    printf("Error: Unimplemented instruction at 0x%04x\n", state->pc);
    exit(1);
}
...
// TODO: make this a part of flag helpers
...
int Emulate8080(State8080* state)
{
    ...
    switch (*opcode)
    {
        ...
        // OUT d8 -- write A to output port (hook up in caller)
        case 0xd3:
            state->pc += 1;
            break;
        ...
        // IN d8 -- read input port into A (hook up in caller)
        case 0xdb:
            state->pc += 1;
            break;
