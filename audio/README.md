...
- **`invaderkilled.wav`** sounds like the shooting effect and vice versa - it seems like they were labeled wrong.
...
Reference for the intended sounds: https://www.youtube.com/watch?v=Sx0ZcT2fY0U

That seems to match the actual machine's sounds, if you'd like to compare: https://www.youtube.com/watch?v=1uSzmzZP1s8
